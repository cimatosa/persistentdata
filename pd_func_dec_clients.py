...
if __name__ == "__main__":
    parser = argparse.ArgumentParser(
        description="starts additional clients for the persistent data function cache"
    )
    ...
    parser.add_argument(
        "--nice", "-ni", type=int, default=19, help="the niceness of the subprocesses"
    )
    ...
    parser.add_argument(
        "--debug", action="store_true", default=False, help="enable debug logging mode"
    )

    parser.add_argument(
        "--info", action="store_true", default=False, help="enable info logging mode"
    )

    parser.add_argument(
        "--logtofile", action="store_true", default=False, help="write log to file"
    )
    ...
    decorators.Cache_Server._start_client(
