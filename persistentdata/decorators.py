...
raise DeprecationWarning(
    "the decorators module is not supported anymore! check out the 'mppfc' package instead."
)
...
#                     raise ValueError(
#                         "can not get db_name from func.__name (__name__ is None)"
#                     )
#
...
#                 raise RuntimeError(
#                     "jobmanager was not imported, can not run 'call_list'"
#                 )
#
...
#
#                 for i in range(l):
#                     args, kwargs = conv_list_args_kwargs(
#                         list_of_args, list_of_kwargs, i
#                     )
#                     try:
...
#                 cs.bring_him_up()
#                 p_client = mp.Process(
#                     target=Cache_Server._start_client,
#                     args=(
#                         "localhost",
#                         cs.authkey,
#                         cs.port,
...
#                     p_client, prefix="local_client", timeout=2
#                 )
#
#             for i in range(l):
#                 if res[i] is None:
